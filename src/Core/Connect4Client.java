 ...
 * version:001
 *
 * This creates the client for the online version of the game
 *
 */
...
public class Connect4Client extends Application implements Connect4Constants {
        ...
        new Thread(() -> {
            try {
                ...
                if (player == PLAYER1) {
                    ...
                    otherToken = 'O';
                    Platform.runLater(() -> {
                        lblTitle.setText("Player 1 with Yellow");
                    ...
                    otherToken = 'X';
                    Platform.runLater(() -> {
                        lblTitle.setText("Player 2 with Red");
    ...
    private void receiveInfoFromServer() throws IOException {
        ...
        if (status == PLAYER2_WON) {
            ...
            if (myToken == 'X') {
                ...
                Platform.runLater(() ->
                        lblStatus.setText("Yellow has won!"));
                receiveMove();
            }
        }
    ...
    public class Cell extends Pane {
        ...
        /**
         * Creates the two tokens that will be used to play the game.
         */
